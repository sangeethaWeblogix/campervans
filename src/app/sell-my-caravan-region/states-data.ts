    ...
    "@graph": [
      {
        ...
        description: `Sell your campervan in ${state.label} with CampervansForSale.au. List for a one-time $49 fee, keep 100% of the sale price, and stay live until sold.`,
        inLanguage: "en-AU",
        ...
        mainEntity: [
          {
            ...
            acceptedAnswer: {
              "@type": "Answer",
              text: `You can sell your campervan in ${state.label} by creating a private seller listing on CampervansForSale.au. Add your campervan details, upload clear photos, set your asking price and publish your ad so buyers across ${state.capital} and regional ${state.label} can contact you directly.`,
            },
          },
          {
            "@type": "Question",
