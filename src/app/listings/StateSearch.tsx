...
const CARAVAN_TYPES = [
  { name: "Family Campervan",   slug: "family-category" },
  { name: "Hybrid Campervan",   slug: "hybrid-category" },
  { name: "Luxury Campervan",   slug: "luxury-category" },
  { name: "Off Road Campervan", slug: "off-road-category" },
  { name: "Pop Top Campervan",  slug: "pop-top-category" },
  { name: "Touring Campervan",  slug: "touring-category" },
...
export default function StateSearch({ filters, onChange, onSearch, onClear }: Props) {
  ...
  const TypeSection = (
    <div className="filter-item">
      <h4 className="filter-section-title">Campervan Type</h4>
  ...
  return (
    <>
          ...
          <div className="search_flex">
            ...
            <div className="filter_btn_top">
              <button className="filter-btn tag" onClick={() => openSection("all")}>
                ...
                {totalActive > 0 && (
                  <span style={{
                    background: "#3f3e82", color: "#fff", borderRadius: "50%",
              ...
              <div className="slider-wrapper">
                <div className="filter-swiper">
                  <button className={`tag${activeType ? " active" : ""}`} onClick={() => openSection("type")}>
                    {activeType ? CARAVAN_TYPES.find((t) => t.slug === filters.type)?.name ?? "Campervan Type" : "Campervan Type"}
      ...
      {openModal === "type"      && <Modal title="Campervan Type" onClear={() => setTempType("All Types")}        onApply={applyType}    clearDisabled={tempType === "All Types"}>{TypeSection}</Modal>}
