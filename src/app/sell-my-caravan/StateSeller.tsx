  ...
  const MAIN_FAQS = [
    {
      ...
      a: <p>You can sell your campervan online by creating a private seller listing on CaravansForSale.com.au. Simply add your campervan details, upload clear photos, set your asking price, and publish your ad so active buyers across {stateLabel} and all of Australia can contact you directly.</p>,
    },
    {
    ...
    },
    {
      ...
      a: <p>Check similar campervans for sale in {stateLabel} before setting your price. Compare by make, model, year, condition, length, ATM, tare weight, sleeping capacity, features and location. A realistic asking price can help attract more genuine buyers.</p>,
    },
    {
    ...
    <div className="page_wrapper demo-page">
      ...
      <section className="demo-hero">
        <div className="container">
          <h1 className="demo-hero__title">
            Sell My Campervan in {stateLabel}
          </h1>
          <p className="demo-hero__subtitle">
            The fastest, safest way to reach active campervan buyers across {capital} and regional {stateLabel}.
          </p>
            ...
            <div className="demo-price-card">
              ...
              <div className="demo-price-card__left">
                ...
                <p className="demo-price-card__desc">
                  List your campervan on Australia's #1 campervan marketplace and connect with thousands of buyers across {capital} and regional {stateLabel}.
                </p>
              </div>
        ...
        <div className="container">
          <div className="demo-features-grid">
            {[
              ...
              { img: "/images/caravan.png", title: "Caravan-Only Marketplace", desc: "Reach engaged campervan buyers actively looking to buy campervans." },
      ...
      <section className="demo-reach-section">
        <div className="container">
          ...
          <div className="demo-reach-heading">
            <h3>Reach Campervan Buyers Across {stateLabel}, Including: </h3>
          </div>
          ...
          <div className="demo-guide-grid">
            ...
            <div className="demo-guide-card">
              ...
              <ul className="demo-guide-card__list">
                ...
                <li>Targeted campervan buyers across {capital} and regional {stateLabel}.</li>
            ...
            <div className="demo-guide-card">
              ...
              <ul className="demo-guide-card__list">
                <li>Check similar campervans for sale in {stateLabel}.</li>
      ...
      <section className="demo-faq-section">
        <div className="container">
          <div className="demo-faq-head">
            ...
            <p>Everything you need to know about selling your campervan in {stateLabel} on CaravansForSale.com.au</p>
          </div>
        ...
        <div className="container">
          <div className="row align-items-center g-4">
            ...
            <div className="col-md-6">
              ...
              <p>
                CaravansForSale.com.au helps {demonym} campervan sellers reach buyers searching for
      ...
      <section className="demo-steps-section">
        <div className="container">
          ...
          <p className="demo-steps-subtitle">List in minutes and reach thousands of active campervan buyers in {stateLabel}.</p>
      ...
      <section className="demo-cta-strip">
        <div className="container text-center">
          ...
          <p className="demo-cta-strip__alt-link">
            Not in {abbr}? Sell your campervan across Australia <a href="/sell-my-caravan/">here</a>.
          </p>
        </div>
      </section>
