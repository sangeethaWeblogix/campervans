          ...
          <div className="hbg-row">
            ...
            <div className="hbg-text-col">
              <h2 className="hbg-title">
                Campervans for Sale Australia: <span className="hbg-title-accent">Buyer Guide</span>
              </h2>
            ...
            <div className="hbg-why-grid">
              ...
              <div className="hbg-why-card">
                <div className="hbg-why-icon">
                  <svg width="34" height="34" viewBox="0 0 24 24" fill="none" stroke="#27264f" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
              ...
              <div className="hbg-why-card">
                ...
                <div className="hbg-why-card-sep" />
                <p className="hbg-why-card-desc">Browse listings from all states and territories and find campervans near you.</p>
              </div>
