...
export const metadata: Metadata = {
  title: 'Home Page Takeover Advertising | #1 Campervan Brand Exposure Australia-Wide',
  description:
    "Dominate Australia's leading campervan marketplace with our exclusive Home Page Takeover. Limited to 1 advertiser per month — maximum visibility, retargeting included, and 100% share of voice for your campervan brand.",
}
        ...
        <div className="container py-5 px-lg-5">
          <div className="col-lg-8">
            {/* <h1 className="display-4 font-black mb-3 text-uppercase tracking-tight">
              Become the #1 Campervan <br className="d-none d-md-block" /> Brand Australia-Wide
            </h1> */}
            <h1 className="display-4 font-black mb-3 text-uppercase tracking-tight">
             Get your Brand Across 1000's of Campervan Buyers Daily  
            </h1>
          ...
          <div className="takeover_box">
            <div className="row g-0 max-width-6xl mx-auto">
              ...
              <div className="col-md-3 p-4 text-center border-end border-light feature-card" data-purpose="feature-card">
                ...
                <p>Reach thousands of serious campervan buyers actively searching.</p>
              </div>
        ...
        <div className="container py-5">
          <div className="text-center mb-5">
            <h2 className="h3 font-black text-navy mb-2 text-uppercase">
              The Ultimate Campervan Marketing Package
            </h2>
            ...
            <div className="col-md-5">
              <div className="package-card d-flex shadow-card" data-purpose="package-item">
                ...
                <div>
                  ...
                  <p className="small fw-medium m-0 lh-base">
                    Reach serious campervan buyers from all over Australia.
                  </p>
                </div>
              </div>
            </div>
