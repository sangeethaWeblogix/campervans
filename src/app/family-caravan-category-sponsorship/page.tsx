...
export const metadata: Metadata = {
  title: 'Family Campervan Category Sponsorship | Australia-Wide Exposure',
  description:
    "Exclusive Off Road Campervan Listing Page Sponsorship for family campervan advertisers. Limited to just 1 advertiser per month — maximum exposure, retargeting included, and 100% share of voice in the family campervan category.",
}
    ...
    <main>
        ...
        <div className="container py-5 px-lg-5">
          <div className="col-lg-8">
            <h1 className="display-4 font-black mb-3 text-uppercase tracking-tight">
              DOMINATE THE FAMILY <br className="d-none d-md-block" /> CAMPERVAN MARKET
            </h1>
      ...
      <section className="py-5 features-overview" data-purpose="features-overview" style={{ background: '#f1f1f1' }}>
        <div className="container">
          <h2 className="h3 font-black text-center mb-5">WHY INVEST IN FAMILY CAMPERVAN CATEGORY SPONSORSHIP?</h2>
          <div className="takeover_box">
            <div className="row g-0 max-width-6xl mx-auto">
              ...
              <div className="col-md-3 p-4 text-center border-end border-light feature-card" data-purpose="feature-card">
                ...
                <p>Be one of only two brands shown to highly interested family campervan buyers.</p>
              </div>
              ...
              <div className="col-md-3 p-4 text-center border-end border-light feature-card" data-purpose="feature-card">
                ...
                <p>Reach thousands of serious family campervan enthusiasts searching for their next model.</p>
              </div>
        ...
        <div className="container py-5">
          <div className="text-center mb-5">
            <h2 className="h3 font-black text-navy mb-2 text-uppercase">
              THE ULTIMATE FAMILY CAMPERVAN MARKETING PACKAGE
            </h2>
              ...
              <div className="package-card d-flex shadow-card" data-purpose="package-item">
                ...
                <div>
                  ...
                  <p className="small fw-medium m-0 lh-base">
                    Your brand in the top-of page position for family campervans.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="col-md-5">
              <div className="package-card d-flex shadow-card" data-purpose="package-item">
                ...
                <div>
                  ...
                  <p className="small fw-medium m-0 lh-base">
                    Limited to just 2 advertisers per category. You get 100% share of voice in family Campervans.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="col-md-5">
              <div className="package-card d-flex shadow-card" data-purpose="package-item">
                ...
                <div>
                  ...
                  <p className="small fw-medium m-0 lh-base">
                    We target users actively searching for family campervans.
                  </p>
                </div>
              </div>
            </div>
